...
exports.CheckCredentialsHandler = void 0;
const cqrs_1 = require("@nestjs/cqrs");
const check_credentials_query_1 = require("./check-credentials.query");
const users_sql_repository_1 = require("../users-sql.repository");
const bcrypt = __importStar(require("bcrypt"));
let CheckCredentialsHandler = class CheckCredentialsHandler {
    usersRepository;
    constructor(usersRepository) {
        this.usersRepository = usersRepository;
    }
    async execute(query) {
        const user = (await this.usersRepository.findByLogin(query.loginOrEmail)) ??
...
exports.CheckCredentialsHandler = CheckCredentialsHandler;
exports.CheckCredentialsHandler = CheckCredentialsHandler = __decorate([
    (0, cqrs_1.QueryHandler)(check_credentials_query_1.CheckCredentialsQuery),
    __metadata("design:paramtypes", [users_sql_repository_1.UsersRepository])
], CheckCredentialsHandler);
//# sourceMappingURL=check-credentials.handler.js.map